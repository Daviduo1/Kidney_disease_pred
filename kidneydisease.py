...
st.markdown("<h4 style = 'margin: -30px; color: #FF204E; text-align: center; font-family: cursive '>Built by Okorom David</h4>", unsafe_allow_html = True)
...
# Add an image
st.image('pngwing.com (6).png', caption = 'Built by David')   
...
st.sidebar.image('pngwing.com (7).png')
...
if st.button('Check your Health Status'):
    if predict[0] == 0:
        ...
        st.image('pngwing.com (9).png', width = 300)
    else:
